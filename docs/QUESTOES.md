...
## Q-017 — `HandoffGenerator.generate()` precisou do `DiscoveredSession` inteiro, não só de `SessionFacts`
**Tarefa:** S2-T2
**Bloqueia:** não esta tarefa (segui com a solução mínima, como `AGENTS.md` pede quando o efeito
...
## Q-018 — Medição real: `--json-schema` não reduz o piso de tokens, aumenta — junto de `--tools ""`
**Tarefa:** S2-T2
