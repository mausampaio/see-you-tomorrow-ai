...
describe('guard: eslint reprova node:* em nucleo/ e fonte não-determinística de tempo fora de relogio/', () => {
  ...
  it('reprova new Date() sem argumento fora de src/adaptadores/relogio/, com mensagem dizendo o que fazer (D-019)', () => {
    const caminho = escreverArquivoTemporario(
  ...
  it('reprova Date.now() fora de src/adaptadores/relogio/, com mensagem dizendo o que fazer (D-019)', () => {
    const caminho = escreverArquivoTemporario(
  ...
  it('aprova new Date(valor) COM argumento fora de src/adaptadores/relogio/ (D-019, o caso permitido)', () => {
    const caminho = escreverArquivoTemporario(
  ...
  it('aprova Date.parse(valor) fora de src/adaptadores/relogio/ (D-019, o caso permitido)', () => {
    const caminho = escreverArquivoTemporario(
  ...
  it('aprova new Date() e Date.now() dentro de src/adaptadores/relogio/ (controle da exceção)', () => {
    const caminho = escreverArquivoTemporario(
